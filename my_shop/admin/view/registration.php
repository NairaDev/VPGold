          ...
          <div class="card" style="border-radius: 15px; background-color:rgba(255,255,255, 0.1);">
            <div class="card-body p-5">
              ...
              <form action="../controller/registration_controller.php" method="post">
				...
				<button  class="btn  btn-block btn-lg gradient-custom-4 text-body" type="submit" name="action" value="submit" style="background-color:#706866;">Register</button>

                </div>

                <p class="text-center text-muted mt-5 mb-0" style="color:black !important;">Have already an account? <a href="login.php"
