...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light nav_header">
      <a class="navbar-brand nav_logo" href="../index.php">VP<i class="fa fa-diamond" aria-hidden="true"></i>GOLD</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item active">
            <a class="nav-link nav_menu_a" href="../index.php">Home</a>
          </li>
          <li class="nav-item">
            <a  class="nav-link nav_menu_a" href="userCards.php">Cards</a>
          </li>
          <li class="nav-item">
            <a  class="nav-link nav_menu_a" href="userOrders.php">Orders</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              ...
              foreach($show_all_categories as $cat){ ?>
                ...
                <a style="font-size:30px; text-decoration:underline;" class="dropdown-item" href="userProducts.php?catId=<?=$cat['iCatId']?>&catName=<?=$cat['vCatName']?>"><?=$cat['vCatName']?></a>
